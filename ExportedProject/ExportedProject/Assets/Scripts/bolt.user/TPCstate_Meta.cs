...
internal class TPCstate_Meta : Bolt.NetworkState_Meta, Bolt.ISerializerFactory, Bolt.IFactory
{
	internal static TPCstate_Meta Instance;

	internal ObjectPool<TPCstate> _pool;
