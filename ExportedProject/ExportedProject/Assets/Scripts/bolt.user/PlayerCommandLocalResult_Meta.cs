...
internal class PlayerCommandLocalResult_Meta : Bolt.NetworkObj_Meta, Bolt.IFactory
{
	internal static PlayerCommandLocalResult_Meta Instance;

	internal ObjectPool<PlayerCommandLocalResult> _pool;
	...
	static PlayerCommandLocalResult_Meta()
	{
	}
