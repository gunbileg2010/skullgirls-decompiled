...
internal class ClickToMoveState_Meta : Bolt.NetworkState_Meta, Bolt.ISerializerFactory, Bolt.IFactory
{
	internal static ClickToMoveState_Meta Instance;

	internal ObjectPool<ClickToMoveState> _pool;
