...
internal class TPCCommandLocalResult_Meta : Bolt.NetworkObj_Meta, Bolt.IFactory
{
	internal static TPCCommandLocalResult_Meta Instance;

	internal ObjectPool<TPCCommandLocalResult> _pool;
	...
	static TPCCommandLocalResult_Meta()
	{
	}
