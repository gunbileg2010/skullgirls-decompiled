...
internal class ClickToMoveCommandLocalResult_Meta : Bolt.NetworkObj_Meta, Bolt.IFactory
{
	internal static ClickToMoveCommandLocalResult_Meta Instance;

	internal ObjectPool<ClickToMoveCommandLocalResult> _pool;
	...
	static ClickToMoveCommandLocalResult_Meta()
	{
	}
