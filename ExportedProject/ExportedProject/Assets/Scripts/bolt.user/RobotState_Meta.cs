...
internal class RobotState_Meta : Bolt.NetworkState_Meta, Bolt.ISerializerFactory, Bolt.IFactory
{
	internal static RobotState_Meta Instance;

	internal ObjectPool<RobotState> _pool;
