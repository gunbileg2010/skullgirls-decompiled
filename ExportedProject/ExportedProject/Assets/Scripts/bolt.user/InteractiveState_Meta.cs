...
internal class InteractiveState_Meta : Bolt.NetworkState_Meta, Bolt.ISerializerFactory, Bolt.IFactory
{
	internal static InteractiveState_Meta Instance;

	internal ObjectPool<InteractiveState> _pool;
