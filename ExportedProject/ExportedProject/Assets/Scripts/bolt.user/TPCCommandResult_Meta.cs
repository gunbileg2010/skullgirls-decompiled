...
internal class TPCCommandResult_Meta : Bolt.NetworkObj_Meta, Bolt.IFactory
{
	internal static TPCCommandResult_Meta Instance;

	internal ObjectPool<TPCCommandResult> _pool;
