...
internal class PlayerCommandInput_Meta : Bolt.NetworkObj_Meta, Bolt.IFactory
{
	internal static PlayerCommandInput_Meta Instance;

	internal ObjectPool<PlayerCommandInput> _pool;
	...
	static PlayerCommandInput_Meta()
	{
	}
