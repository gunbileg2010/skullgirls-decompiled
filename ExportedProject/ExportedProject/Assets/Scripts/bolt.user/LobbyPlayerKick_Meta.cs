...
internal class LobbyPlayerKick_Meta : Bolt.Event_Meta, Bolt.IEventFactory, Bolt.IFactory
{
	internal static LobbyPlayerKick_Meta Instance;

	internal ObjectPool<LobbyPlayerKick> _pool;
