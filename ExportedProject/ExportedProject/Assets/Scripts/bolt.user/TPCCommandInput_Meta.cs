...
internal class TPCCommandInput_Meta : Bolt.NetworkObj_Meta, Bolt.IFactory
{
	internal static TPCCommandInput_Meta Instance;

	internal ObjectPool<TPCCommandInput> _pool;
