...
internal class WeaponSlot_Meta : Bolt.NetworkObj_Meta, Bolt.IFactory
{
	internal static WeaponSlot_Meta Instance;

	internal ObjectPool<WeaponSlot> _pool;
