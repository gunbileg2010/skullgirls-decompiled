...
public class PunchPosition : EZAnimation
{
	...
	public static PunchPosition Do(GameObject sub, Vector3 mag, ref EZAnimOptions options, Action<EZAnimation> startDel, Action<EZAnimation> stopDel)
	{
		return null;
	}

	public static PunchPosition Do(GameObject sub, Vector3 mag, float dur, float delay, Action<EZAnimation> startDel, Action<EZAnimation> stopDel)
	{
		return null;
	}
