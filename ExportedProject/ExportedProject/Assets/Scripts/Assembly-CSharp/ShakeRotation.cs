...
public class ShakeRotation : EZAnimation
{
	...
	public static ShakeRotation Do(GameObject sub, Vector3 mag, float oscill, ref EZAnimOptions options, Action<EZAnimation> startDel, Action<EZAnimation> stopDel)
	{
		return null;
	}

	public static ShakeRotation Do(GameObject sub, Vector3 mag, float oscill, float dur, float delay, Action<EZAnimation> startDel, Action<EZAnimation> stopDel)
	{
		return null;
	}
