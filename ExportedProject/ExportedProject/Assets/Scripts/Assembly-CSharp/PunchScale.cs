...
public class PunchScale : EZAnimation
{
	...
	public static PunchScale Do(GameObject sub, Vector3 mag, ref EZAnimOptions options, Action<EZAnimation> startDel, Action<EZAnimation> stopDel)
	{
		return null;
	}

	public static PunchScale Do(GameObject sub, Vector3 mag, float dur, float delay, Action<EZAnimation> startDel, Action<EZAnimation> stopDel)
	{
		return null;
	}
